...
CHAPTER_TITLES = {
    ...
    2: ("Über vorgefaßte Meinungen", "先入見について"),
    3: ("Mein Verhältnis zu R. Avenarius und andern Forschern", "アヴェナリウスおよび他の研究者との関係"),
    4: ("Die Hauptgesichtspunkte für die Untersuchung der Sinne", "感覚の研究のための主要な観点"),
    5: ("Physik und Biologie. Kausalität und Teleologie", "物理学と生物学。因果性と目的論"),
    6: ("Die Raumempfindungen des Auges", "目の空間感覚"),
    7: ("Weitere Untersuchung der Raumempfindungen", "空間感覚のさらなる研究"),
    8: ("Der Wille", "意志"),
    9: ("Eine biologisch-teleologische Betrachtung über den Raum", "空間についての生物学的・目的論的考察"),
    10: ("Beziehungen der Gesichtsempfindungen zu einander und zu andern psychischen Elementen", "視覚感覚の相互関係と他の心的要素との関係"),
    11: ("Empfindung, Gedächtnis und Assoziation", "感覚・記憶・連合"),
    12: ("Die Zeitempfindung", "時間感覚"),
    13: ("Die Tonempfindungen", "音の感覚"),
